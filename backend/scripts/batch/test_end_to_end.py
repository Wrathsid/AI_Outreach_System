                ...
                if line:
                    try:
                        ...
                        if data["type"] == "result":
                            candidate = data["data"]
                            print(
                                f"    - Found: {candidate.get('name')} | {candidate.get('title')} @ {candidate.get('company')}"
                            )
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                if draft_res.status_code == 200:
                    ...
                    print(
                        f"    --- DRAFT CONTENT ({draft.get('intent', 'unknown')}) ---"
                    )
