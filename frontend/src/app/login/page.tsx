  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
         <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-purple-900/10 blur-[120px] rounded-full animate-ambient-drift"></div>
         <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-900/10 blur-[100px] rounded-full animate-ambient-drift-slow"></div>
         ...
         <svg className="absolute inset-0 w-full h-full opacity-[0.02]" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
           ...
           <rect fill="url(#loginGrid)" width="100%" height="100%" />
         </svg>
      </div>
